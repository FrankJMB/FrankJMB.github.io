 ...
 * Licensed under MIT (https://github.com/afeld/bootstrap-toc/blob/gh-pages/LICENSE.md) */!function(e){"use strict";window.Toc={helpers:{findOrFilter:function(e,t){var n=e.find(t);return e.filter(t).add(n).filter(":not([data-toc-skip])")},generateUniqueIdBase:function(t){return e(t).text().trim().replace(/'/gi,"").replace(/[& +$,:;=?@"#{}|^~[`%!'<>\]./()*\\\n\t\b\v]/g,"-").replace(/-{2,}/g,"-").substring(0,64).replace(/^-+|-+$/gm,"").toLowerCase()||t.tagName.toLowerCase()},generateUniqueId:function(e){for(var t,s=this.generateUniqueIdBase(e),n=0;;n++)if(t=s,0<n&&(t+="-"+n),!document.getElementById(t))return t},generateAnchor:function(e){if(e.id)return e.id;var t=this.generateUniqueId(e);return e.id=t},createNavList:function(){return e('<ul class="nav navbar-nav"></ul>')},createChildNavList:function(e){var t=this.createNavList();return e.append(t),t},generateNavEl:function(t,n){var o,s=e('<a class="nav-link"></a>');return s.attr("href","#"+t),s.text(n),o=e("<li></li>"),o.append(s),o},generateNavItem:function(t){var s=this.generateAnchor(t),n=e(t),o=n.data("toc-text")||n.text();return this.generateNavEl(s,o)},getTopLevel:function(e){for(var t=1;t<=6;t++)if(1<this.findOrFilter(e,"h"+t).length)return t;return 1},getHeadings:function(e,t){var n="h"+t,s="h"+(t+1);return this.findOrFilter(e,n+","+s)},getNavLevel:function(e){return parseInt(e.tagName.charAt(1),10)},populateNav:function(e,t,n){var o,s=e,i=this;n.each(function(n,a){var r=i.generateNavItem(a);i.getNavLevel(a)===t?s=e:o&&s===e&&(s=i.createChildNavList(o)),s.append(r),o=r})},parseOps:function(t){var n;return(n=t.jquery?{$nav:t}:t).$scope=n.$scope||e(document.body),n}},init:function(e){(e=this.helpers.parseOps(e)).$nav.attr("data-toggle","toc");var n=this.helpers.createChildNavList(e.$nav),t=this.helpers.getTopLevel(e.$scope),s=this.helpers.getHeadings(e.$scope,t);this.helpers.populateNav(n,t,s)}},e(function(){e('nav[data-toggle="toc"]').each(function(t,n){var s=e(n);Toc.init(s)})})}(jQuery)
